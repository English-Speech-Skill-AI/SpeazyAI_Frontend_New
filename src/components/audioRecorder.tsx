...
export function AudioRecorder({
  ...
  const callSpeechAssessmentAPI = async (base64Audio, format) => {
    ...
    const payloadObj: any = {
      ...
      audio_format: format,
      endpoint, // so DO function gets it even if query string is stripped
    }
    ...
    try {
      ...
      // Unwrap proxy response: DO returns { statusCode, body } where body may be object or string; local returns assessment directly
